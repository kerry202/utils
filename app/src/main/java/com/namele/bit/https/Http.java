...
//    public static final String TEST_ROOT = "http://api.dce.cash:81";
//    public static final String PHP_ROOT = "https://developer.dce.cash";
    ...
    public static final String TEST_ROOT = "http://test.www.dce.cash:3002";
     ...
     * 充值  用户信息
     */
    public static final String withdrawal_user_msg = TEST_ROOT + "/userCoin/getUserInfoByAddress";
